...
<div class="content-body">
  ...
  @endif
        ...
        <div class="form-head d-flex mb-sm-4 mb-3">
          <div class="mr-auto">
            <h2 class="text-black font-w600">ARL</h2>
            <p class="mb-0">Empleados registrados en la compañía</p>
          </div>
          <div>
            <a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+Nuevo ARL</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="/gestion/nomina/crear-arl" method="post">
                  <div class="form-group">
                    <label class="text-black" style="font-size: 16px;">ARL</label>
                    <input type="text" name="val-arl" class="form-control">
                  </div>
                  <div class="form-group">
              ...
              <table id="example5" class="display dataTablesCard table-responsive-xl">
                ...
                @foreach($bancos as $bancos)
                  <tr>
                    ...
                    <td class="val-arl">{{$bancos->arl}}</td>
                    ...
                    <td>
                      <div class="dropdown ml-auto text-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a class="dropdown-item" href="/gestion/nomina/eliminar-arl/{{$bancos->id}}">Delete</a>
                        </div>
                      </div>
                    </td>                       
                  </tr>
...
<div class="modal fade" id="modal1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/gestion/nomina/editar-arl" method="post">
      <div class="modal-body">
          <div class="form-group">
           <label class="text-black" style="font-size: 16px;">Banco</label>
           <input type="text" name="val-arl" class="form-control val-arl">
           </div>
           <div class="form-group">
           <label class="text-black" style="font-size: 16px;">Identificador</label>
