...
<div class="content-body">
  ...
  @endif
        ...
        <div class="form-head d-flex mb-sm-4 mb-3">
          <div class="mr-auto">
            <h2 class="text-black font-w600">Fondos de Pension</h2>
            <p class="mb-0">Empleados registrados en la compañía</p>
          </div>
          <div>
            <a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+Nuevo Fondo Pension</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Agregar Fondo de Pension</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form action="/gestion/nomina/crear-pensiones" method="post">
                  <div class="form-group">
                    <label class="text-black" style="font-size: 16px;">Fondo Pension</label>
                    <input type="text" name="val-pension" class="form-control">
                  </div>
                  <div class="form-group">
              ...
              <table id="example5" class="display dataTablesCard table-responsive-xl">
                ...
                @foreach($bancos as $bancos)
                  <tr>
                    ...
                    <td class="val-pension">{{$bancos->pension}}</td>
                    ...
                    <td>
                      <div class="dropdown ml-auto text-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a class="dropdown-item" href="/gestion/nomina/eliminar-pensiones/{{$bancos->id}}">Delete</a>
                        </div>
                      </div>
                    </td>                       
                  </tr>
...
<div class="modal fade" id="modal1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/gestion/nomina/editar-pensiones" method="post">
      <div class="modal-body">
          <div class="form-group">
           <label class="text-black" style="font-size: 16px;">Banco</label>
           <input type="text" name="val-pension" class="form-control val-pension">
           </div>
           <div class="form-group">
           <label class="text-black" style="font-size: 16px;">Identificador</label>
