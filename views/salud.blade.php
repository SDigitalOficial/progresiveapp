...
<div class="content-body">
  ...
  @endif
        ...
        <div class="form-head d-flex mb-sm-4 mb-3">
          <div class="mr-auto">
            <h2 class="text-black font-w600">Fondos de Salud</h2>
            <p class="mb-0">Empleados registrados en la compañía</p>
          </div>
          <div>
            <a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+Nuevo Fondo Salud</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Agregar Fondo de Salud</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <form action="/gestion/nomina/crear-salud" method="post">
                  <div class="form-group">
                    <label class="text-black" style="font-size: 16px;">Fondo Salud</label>
                    <input type="text" name="val-salud" class="form-control">
                  </div>
                  <div class="form-group">
              ...
              <table id="example5" class="display dataTablesCard table-responsive-xl">
                ...
                @foreach($bancos as $bancos)
                  <tr>
                    ...
                    <td class="val-salud">{{$bancos->salud}}</td>
                    ...
                    <td>
                      <div class="dropdown ml-auto text-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          ...
                          <a class="dropdown-item" href="/gestion/nomina/eliminar-salud/{{$bancos->id}}">Delete</a>
                        </div>
                      </div>
                    </td>                       
                  </tr>
...
<div class="modal fade" id="modal1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/gestion/nomina/editar-salud" method="post">
      <div class="modal-body">
          <div class="form-group">
           <label class="text-black" style="font-size: 16px;">Banco</label>
           <input type="text" name="val-salud" class="form-control val-salud">
           </div>
           <div class="form-group">
           <label class="text-black" style="font-size: 16px;">Identificador</label>
